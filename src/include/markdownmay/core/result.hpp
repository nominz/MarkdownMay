...
enum class ErrorCode : std::uint32_t {
    ...
    file_read_only = 4014,
    split_invalid_position = 4101,
    split_target_conflict = 4102,
    split_candidate_warning = 4103,
    split_commit_failed = 4104,
    split_rollback_failed = 4105,
    insert_invalid_position = 4201,
    insert_source_unsupported = 4202,
    insert_target_unsaved = 4203,
    insert_path_rewrite_failed = 4204,
    insert_resource_failed = 4205,
    insert_transaction_failed = 4206,
    insert_rollback_failed = 4207,
    ...
    platform_placement_verify_failed = 7403,
    platform_placement_target_changed = 7404,
    platform_placement_launch_failed = 7405,
