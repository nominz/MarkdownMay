...
项目已形成可运行的 Windows 原生单 EXE，支持三种编辑视图、H1～H6 标题折叠与大纲、日常文件操作、Markdown/TXT 文档、PDF/DOCX/TXT/HTML 导出、文件关联、主题、DPI、打印和本地设置。当前版本尚未正式发布。

新任务继续本项目时，请从[项目交接基线](docs/项目交接基线_2026-08-02/00_新任务接续入口.md)开始阅读，并按入口跳转到最新交接文件和正式需求基线。
